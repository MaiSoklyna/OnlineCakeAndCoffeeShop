...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Redirect them back to the page they were trying to visit
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 text-lg">Welcome back! Please login to your account.</p>
        </div>
        
        <div className="bg-white py-8 px-6 shadow-lg rounded-xl border border-gray-100 transition-all duration-300 hover:shadow-xl">
          <h2 className="text-center text-xl font-bold text-gray-800 mb-8">Log In</h2>
          ...
          <div className="mt-8 border-t border-gray-200 pt-6">
            <div className="flex flex-col space-y-4">
              <button className="w-full flex items-center justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors">
